...
// This is specially useful for tool that extract implicitly all possible label keys.
...
//
// All we need to extract is the status_code in the json tool.
...
// newParserHint creates a new tool hint using the list of labels that are seen and required in a query.
